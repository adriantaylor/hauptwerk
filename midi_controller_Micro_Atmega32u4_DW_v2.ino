/*
  ...
  Modified by Adrian Taylorr for Haupterk Pistons (to remove Analogue inputs - add them back in to add swell pedals etc)
...
const int buttonPin[NButtons] = {2, 3, 4, 5, 7, 8, 9, 10, 14, 15, 16};
...
// MIDI Assignments 
byte midiCh = 6; //* MIDI channel to be used
